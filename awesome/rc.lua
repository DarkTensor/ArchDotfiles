...
beautiful.init("/home/a/.config/awesome/theme.lua")
...
mytextclock.font = "DejaVuSansM Nerd Font 12"
...
globalkeys = gears.table.join(
    ...
    awful.util.spawn("dmenu_run -c -l 20") end,
    ...
    awful.util.spawn("brave") end,
              {description = "launch browser (brave)", group = "launcher"}),
     
    -- Scrot
    awful.key({},    "Print",  function () 
    awful.util.spawn("screenshot") end,
              {description = "takes a screenshot", group = "launcher"}),
